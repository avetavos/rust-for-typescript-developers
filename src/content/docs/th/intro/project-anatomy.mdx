...
<Mermaid code={binCrateTree} title="สิ่งที่ cargo new ให้มา (binary crate)" />
...
<Mermaid code={libCrateTree} title="โครงสร้าง library crate" />
...
<Mermaid code={moduleTree} title="โปรเจกต์ที่มี module" />
...
<Mermaid code={targetTree} title="ไดเรกทอรี target/" />
