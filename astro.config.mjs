...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        ...
        { label: 'Rust 101 — Fundamentals', collapsed: true, items: [{ autogenerate: { directory: 'rust-101' } }] },
        ...
        { label: 'Building an API with Axum', collapsed: true, items: [{ autogenerate: { directory: 'api-axum' } }] },
        { label: 'Advanced Rust', collapsed: true, items: [{ autogenerate: { directory: 'advanced' } }] },
